...
#  @WebTest @PositiveCase @Register
  Scenario Outline: Register with valid input
    ...
    Examples:
      ...
      | Ghalda   | Ghald123@gmail.com | Satudua3! | 08135388651 | address |
    ...
    Scenario Outline: Register with the length password equal to 8
      ...
      Examples:
        | fullName | email                       | password | phone        | address |
        | Ghalda   | ghaldaadmin1@temanpetani.id | Ghalda1! | 081213141516 | address |
    ...
    Scenario Outline: Register with password more than
      ...
      Examples:
        | fullName | email                       | password  | phone        | address |
        | Ghalda   | ghaldaadmin2@temanpetani.id | Ghaldaa1! | 081213141516 | address |
